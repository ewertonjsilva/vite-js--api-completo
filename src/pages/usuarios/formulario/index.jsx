...
import MudaSenha from '../../../imagens/icones/mudaSenha.svg';
import NovaSenha from '../../../imagens/icones/novaSenha.svg';
import Cancelar from '../../../imagens/icones/cancel.svg';
            ...
            <form id="form" className={styles.form} onSubmit={handleSubmit}>
                ...
                <div className={exibeMudaSenha ? styles.mudaSenha : styles.escondeMudaSenha}>
                    ...
                    <button className={styles.button} type="submit">
                        <img className={styles.img} src={NovaSenha} alt="cadastrar" />
                        {/* <MdPersonAddAlt /> */}
                        Gravar nova senha
                    </button>
                </div>
                ...
                <button className={styles.button} type="button" onClick={() => mostraOcultaSenha()}>
                    <img className={styles.img} src={exibeMudaSenha ? Cancelar : MudaSenha} alt="cadastrar" />
                    {/* <MdPersonAddAlt /> */}
